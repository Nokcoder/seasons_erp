...
export const qk = {
  ...
  customerTransactionLedger: (id: number)           => ['customers', id, 'transaction-ledger'] as const,
  ...
  receiptsSetting:  () => ['receiptsSetting'] as const,
  receiptsAutoPrint:() => ['receiptsAutoPrint'] as const,
